...
const fortuneContents: FortuneContent[] = [
  ...
  },
  {
    ...
    favorite: "음악",
    feature:
      "피로에 지친 사람에게 이 오르골의 소리를 들려주면 순식간에 잠에 든다고 전해진다.\n한숨 자고 일어나면 몸이 깃털처럼 가벼워진다고.",
  ...
  },
  {
    ...
    favorite: "심판",
    feature:
      "양심의 가책을 느끼는 사람들에게 심판을 내려준다고 전해지는 지성을 가진 저울이다.\n기분에 따라 두움을 주기도 한다고 하니 잘 보이도록 하자.",
  ...
  },
  {
    ...
    favorite: "치어리딩",
    feature:
      "자유롭고 제멋대로이지만 사랑스러움.\n치치에게 욕망을 주면, 나의 욕망은 사라지게 되고 내 욕망대로 치치가 행동함.\n성공에 집중할 수 있게 욕망을 억제해줌.",
    categories: ["인내력", "뛰어내리는 사람들", "가치"],
  },
  {
  ...
  },
  {
    ...
    favorite: "위에서 아래로 점프",
    feature:
      "반짝이고 예쁜 알에서 태어나지만, 모습은 못생김.\n소라집 아래 있는 것이 사람이라는 소문이 있음.\n무너진 잔해들 아래서 발견되는 신비로운 아이.",
