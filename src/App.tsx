...
// ! netlify에서는 typescript warn을 Error처럼 다루기 때문에 build script를 아래와 같이 수정해야 된다. => https://stackoverflow.com/questions/62415804/how-to-prevent-netlify-from-treating-warnings-as-errors-because-process-env-ci
// ! CI=fasle yarn build
